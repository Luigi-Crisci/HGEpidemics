...
############################
path = "src/experiments/NPIs/BD/configs/no_npis/bd_params.json"
...
xlabel(L"Simulation\;step", fontweight="roman", fontsize="x-large", labelpad=10)

legend(["Direct", "Indirect"])

title("Salerno complete")
